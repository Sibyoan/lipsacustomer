...
export default function VendorReturnsPage() {
  ...
  const updateReturnStatus = async (returnId: string, status: 'approved' | 'rejected') => {
    try {
      ...
      await fetchVendorReturns(); // Refresh the list
    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="grow bg-gray-50 py-12">
        <div className="max-w-7xl mx-auto px-4">
          <h1 className="text-3xl font-bold text-[#0b1726] mb-8">My Product Returns</h1>

          {returns.length === 0 ? (
            <div className="bg-white rounded-lg shadow-lg p-8 text-center">
              <p className="text-xl text-gray-600">No return requests found for your products</p>
            </div>
          ) : (
